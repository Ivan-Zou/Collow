...
app.get(`/average_county_info/:id`, routes.average_county_info);
app.get(`/maximum_county_info/:id`, routes.maximum_county_info);
app.get(`/minimum_county_info/:id`, routes.minimum_county_info);
